...
```
cd existing_repo
git remote add origin https://gitlab.com/digiratory/sdd-segmentation.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/digiratory/sdd-segmentation/-/settings/integrations)
